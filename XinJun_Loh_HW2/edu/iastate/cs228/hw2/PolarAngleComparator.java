...
public class PolarAngleComparator implements Comparator<Point>
{
	...
	public int compare(Point p1, Point p2)
	{
		...
		else if(comparePolarAngle(p2, referencePoint)==1 || comparePolarAngle(p1, p2)==0 && compareDistance(p1, p2)==-1) {
			return -1;
		}
		else {
			return 1;
    ...
    {
    	// TODO 
    	if(!p1.equals(referencePoint) && !p2.equals(referencePoint) && crossProduct(p1, p2)==0 && dotProduct(p1, p2)>0) {
    		return 0;
    	}
    		...
    		if(p1.getY()<referencePoint.getY() && p2.getY()<referencePoint.getY() && crossProduct(p1, p2)>0) {
    			...
    			else if(p2.getY()==referencePoint.getY() && p1.getX()>referencePoint.getX() && p2.getX()<referencePoint.getX()) {
    				return -1;
    			}
    ...
    {
    	// TODO 
    	int cross=((p1.getX()-referencePoint.getX())*(p2.getY()-referencePoint.getY())) - ((p1.getY()-referencePoint.getY()*(p2.getX()-referencePoint.getX())));
    	return cross; 
    }
    ...
    {
    	// TODO 
    	int dot=((p1.getX()-referencePoint.getX())*(p2.getX()-referencePoint.getX())) + ((p1.getY()-referencePoint.getY())*(p2.getY()-referencePoint.getY()));
    	return dot; 
    }
}
